...
from company_data_collector.seedwork.domain.entities import RootAggregation
from company_data_collector.modules.company.domain.events import CompanyCreated
