from company_data_processor.seedwork.application.dto import Mapper as AppMap
from company_data_processor.seedwork.domain.repositories import Mapper as RepMap
