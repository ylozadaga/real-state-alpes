from company_data_processor.seedwork.application.commands import Command
from company_data_processor.modules.company.application.dto import CompanyDTO
from .base import CreateCompanyBaseHandler
from dataclasses import dataclass, field
from company_data_processor.seedwork.application.commands import execute_command as command

from company_data_processor.modules.company.domain.entities import Company
from company_data_processor.seedwork.infrastructure.uow import UnitWorkPort
from company_data_processor.modules.company.application.mappers import CompanyMapper
from company_data_processor.modules.company.infrastructure.repositories import CompanyRepository
