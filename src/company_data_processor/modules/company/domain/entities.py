...
from src.company_data_processor.seedwork.domain.entities import RootAggregation
from src.company_data_processor.modules.company.domain.events import CompanyCreated
